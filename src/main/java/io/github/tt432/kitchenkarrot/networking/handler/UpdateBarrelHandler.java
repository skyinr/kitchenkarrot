...
public class UpdateBarrelHandler implements IPayloadHandler<C2SUpdateBarrelPacket> {
    ...
    @Override
    public void handle(
            @NotNull C2SUpdateBarrelPacket c2SUpdateBarrelPacket, IPayloadContext iPayloadContext) {
                    ...
                    if (level.isLoaded(c2SUpdateBarrelPacket.pos())) {
                        ...
                        if (blockState.getBlock() instanceof BrewingStandBlock) {
                            level.setBlock(
                                    ...
                                    blockState.setValue(
                                            BrewingBarrelBlock.OPEN, c2SUpdateBarrelPacket.value()),
                                    BrewingStandBlock.UPDATE_ALL);
                        }
                    }
                });
    }
