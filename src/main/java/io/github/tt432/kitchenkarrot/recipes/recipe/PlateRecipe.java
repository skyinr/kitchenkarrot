...
public class PlateRecipe extends BaseRecipe {
    public static final MapCodec<PlateRecipe> CODEC = RecordCodecBuilder.mapCodec(builder -> builder.group(
            ItemStack.SINGLE_ITEM_CODEC.fieldOf("input").forGetter(plateRecipe -> plateRecipe.input),
            ItemStack.SINGLE_ITEM_CODEC.fieldOf("result").forGetter(plateRecipe -> plateRecipe.result),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, PlateRecipe> STREAM_CODEC = StreamCodec.composite(
            ItemStack.STREAM_CODEC, recipe -> recipe.input,
