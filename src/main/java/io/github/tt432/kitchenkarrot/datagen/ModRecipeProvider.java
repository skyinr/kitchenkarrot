...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected static final InventoryChangeTrigger.TriggerInstance HAS_OIL = has(ModItemTags.OIL);
    protected static final InventoryChangeTrigger.TriggerInstance HAS_SALT = has(ModItemTags.SALT);
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> c) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.EMPTY_PLATE.get(), 2).group(KK)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.EMPTY_PLATE.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.KNIFE.get()).group(KK)
                ...
                .unlockedBy(getHasName(Items.IRON_NUGGET), has(Items.IRON_NUGGET))
                .save(c, RL(getSimpleRecipeName(ModItems.KNIFE.get())));
        ...
        foodShapeless(ModItems.PHANTOM_STEW)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.PHANTOM_STEW.get())));
        foodShapeless(ModItems.STONE_SHORE_QUICHE)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.STONE_SHORE_QUICHE.get())));
        foodShapeless(ModItems.CRIMSON_FUNGI_SPRING_ROLL, 2)
                ...
                .unlockedBy(ModItems.CARROT_SPICES)
                .save(c, RL(getSimpleRecipeName(ModItems.CRIMSON_FUNGI_SPRING_ROLL.get())));
        foodShapeless(ModItems.BUCHE_DE_NOEL)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.BUCHE_DE_NOEL.get())));
        foodShapeless(ModItems.MIXED_NUTS_MOONCAKE)
                ...
                .unlockedBy(Items.WHEAT)
                .save(c, RL(getSimpleRecipeName(ModItems.MIXED_NUTS_MOONCAKE.get())));
        foodShapeless(ModItems.BIRCH_SAP_DONUT)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.BIRCH_SAP_DONUT.get())));
        foodShapeless(ModItems.BIKINI_BOTTOM_SUB)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.BIKINI_BOTTOM_SUB.get())));
        ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, ModItems.ENCHANTED_CHEESE.get()).group(KK)
                ...
                .save(c, RL(getSimpleRecipeName(ModItems.ENCHANTED_CHEESE.get())));
    }
