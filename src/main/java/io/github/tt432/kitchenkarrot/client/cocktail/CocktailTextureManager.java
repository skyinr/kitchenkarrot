...
public class CocktailTextureManager extends TextureAtlasHolder {
    public static final CocktailTextureManager INSTANCE =
            new CocktailTextureManager(Minecraft.getInstance().getTextureManager());

    private CocktailTextureManager(TextureManager p_262057_) {
        super(
                p_262057_,
                ResourceLocation.fromNamespaceAndPath(
                        Kitchenkarrot.MOD_ID, "textures/atlas/cocktail.png"),
