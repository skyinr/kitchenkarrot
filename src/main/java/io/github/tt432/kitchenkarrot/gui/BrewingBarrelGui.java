...
public class BrewingBarrelGui extends KKGui<BrewingBarrelMenu> {
    ...
    public static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Kitchenkarrot.MOD_ID, "textures/gui/brewing_barrel.png");
    ...
    protected void init() {
        ...
        if (be.getLevel() != null) {
            IFluidHandler capability = be.getLevel().getCapability(Capabilities.FluidHandler.BLOCK, be.getBlockPos(), null);
                ...
                addRenderableWidget(new ProgressWidget(this, TEXTURE, leftPos + 152, topPos + 23,
                        ...
                        () -> {
                            if (be.isStarted()) {
                                ...
                                Optional<RecipeHolder<BrewingBarrelRecipe>> recipe = be.findRecipe();
                                if (recipe.isPresent() && be.hasEnoughWater(recipe.get().value())) {
