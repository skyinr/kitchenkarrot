...
public class ModItemTags {
    ...
    public static final TagKey<Item> OIL =
            ItemTags.create(ResourceLocation.parse("forge:cooking_oil"));
    ...
    public static final TagKey<Item> ICE_CUBES =
            ItemTags.create(ResourceLocation.parse("forge:ice_cubes"));
    public static final TagKey<Item> ACORN =
            ItemTags.create(ResourceLocation.parse("forge:nuts/acorn"));
